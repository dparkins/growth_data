...
!ccccccccccccccccccccccccccccccccccccccccccccccccccc
        ...
        Type MatterTransferData
         ...
         real(dl), dimension (:,:), pointer :: linear_growth
...
!          end if
        ...
        subroutine Transfer_Get_sigma8(MTrans, sigr8)
         ...
         do in = 1, CP%InitPower%nn
          ...
          do ik=1, MTrans%num_q_trans
               ...
               if(ik.eq.27) MTrans%linear_growth(itf,in) = delta
        ...
        subroutine Transfer_Allocate(MTrans)
         ...
         integer st
          ...
          deallocate(MTrans%linear_growth, STAT = st)
          ...
          allocate(MTrans%linear_growth(CP%transfer%num_redshifts, CP%InitPower%nn))
